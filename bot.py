...
class Bot(discord.Client):
    ...
    async def NewMedic(self, context, name):
        ...
        await temp.send(" - Licence hélicotpère")
        ...
        await temp.send(" - Procédure visite médicales de mise en fédérale")
        ...
        await temp.send(embed=embedVar)
        await temp.send(" - Archivage")
        await temp.send(" - Stocks")
        await temp.send(" - Secourisme")
        await temp.send(" - Supervision")
        await temp.send(" - Inspection")
        await temp.send(" - Psychologie")
